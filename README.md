...
/* todo: attachments are not completely decoupled from documents. Although they are stored in different places, documents maintain
   data about attachments in their `@metadata` and they can be part of the transaction */
